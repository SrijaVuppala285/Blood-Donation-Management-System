    ...
    <main>
      ...
      <section className="mx-auto max-w-5xl px-4 py-12">
        ...
        <p className="leading-relaxed text-gray-700">
          BloodConnect links donors and recipients to make blood donation faster, safer, and more rewarding. We empower
          communities through time‑bound campaigns and real‑time emergency support.
        </p>
